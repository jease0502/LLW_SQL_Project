...
class create_date:
    ...
    def creat_college_and_creat_department(self):
        college = {'會計系':'商學院','國貿系':'商學院','國際經營與貿易學系國際企業管理全英語學士班':'商學院','財稅系':'商學院','合經系':'商學院','統計系':'商學院','經濟系':'商學院','企管系':'商學院','行銷系':'商學院','商學學士學位學程':'商學院',
                    '機電系':'工程與科學學院','纖複系':'工程與科學學院','工工系':'工程與科學學院','化工系':'工程與科學學院','航太系':'工程與科學學院','精密系統設計學士學位學程':'工程與科學學院','應數系':'工程與科學學院','環工系':'工程與科學學院','材料系':'工程與科學學院','光電系':'工程與科學學院',
                    '資工系':'資電學院','電機系':'資電學院','電子系':'資電學院','自控系':'資電學院','通訊系':'資電學院','資訊電機學院學士班':'資電學院',
                    '土木系':'建設學院','水利系':'建設學院','都資系':'建設學院','運輸物流系':'建設學院','土管系':'建設學院'
        }
