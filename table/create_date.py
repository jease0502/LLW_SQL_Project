...
class create_date:
    ...
    def creat_college_and_creat_department(self):
        college = {'會計系':'商學院','國貿系':'商學院','國貿系全英班':'商學院','財稅系':'商學院','合經系':'商學院','統計系':'商學院','經濟系':'商學院','企管系':'商學院','行銷系':'商學院','商學學士學位學程':'商學院',
                    '機電系':'工程與科學學院','纖複系':'工程與科學學院','工工系':'工程與科學學院','化工系':'工程與科學學院','航太系':'工程與科學學院','精密學程':'工程與科學學院','應數系':'工程與科學學院','環工系':'工程與科學學院','材料系':'工程與科學學院','光電系':'工程與科學學院',
